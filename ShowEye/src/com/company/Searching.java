...
public class Searching {
     ...
     * @return An arrayList of entertainment objects named Entertainment_Holder
     */

    public ArrayList<Entertainment> Search_by_Name (String userString, String pathname)
    {
